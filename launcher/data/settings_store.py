...
DEFAULTS: dict[str, Any] = {
    ...
    "discord_large_static": "milso-logo",
    "discord_large_template": "",
    "discord_large_text": "{game}",
    "discord_small_key": "",
    "discord_small_text": "{elapsed}",
    "discord_show_elapsed": True,
    "discord_idle_enabled": False,
    "discord_idle_text": "Browsing library",
